...
const TABS: TabDef[] = [
  ...
  {
    id: 'language', icon: 'layers', status: 'coming',
    labelEn: 'Language & Translation', labelZh: '语言与翻译',
    descEn:  'Primary language, RTL, add languages, AI translation',
    descZh:  '主语言、RTL、添加语言、AI 翻译',
  },
  {
  ...
  },
  {
    ...
    descEn:  'Version display, NDA text & enforcement settings',
  ...
  },
  {
    ...
    descEn:  'Kimi behavior config, prompt templates, rate limits',
    ...
    <div style={{ width: '100%', maxWidth: 1040 }}>
      ...
      <div style={{ marginBottom: 24 }}>
        <h1 style={{ fontSize: 20, fontWeight: 700, color: 'var(--text-primary)', marginBottom: 4 }}>
          {isZh ? '管理设置' : 'Admin Setup'}
        </h1>
        <p style={{ fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.5 }}>
          {isZh
            ? '配置您的 Hub 设置。这些设置将影响所有用户看到的内容。'
            : 'Configure your hub settings. These affect how the hub appears to all users.'}
        </p>
      </div>
      ...
      <div style={{ display: 'flex', gap: 20, alignItems: 'flex-start' }}>
        ...
        <div style={{ width: 252, flexShrink: 0, position: 'sticky', top: 0, alignSelf: 'flex-start' }}>
          ...
          {/* Save / Reset — only for tabs that have live content */}
          {activeTabDef.status === 'live' && (
            <div style={{
